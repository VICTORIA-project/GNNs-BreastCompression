...
def Graph_load_batch(name, min_num_nodes=20, max_num_nodes=17595):
    ...
    data_adj = np.loadtxt('dataset/' + name + '/A.csv', delimiter=',').astype(int)     
    # ---------------------------------------------------------------------------------------
...
path = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '/a/' #
# path = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '/b/' #
# path = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '/c/' #
# path = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '/d/' #
# path = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '/e/' #
# path = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '/f/' #
# path = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '/g/' #  
# path = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '/h/' #
# path = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '/i/' #
# path = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '/j/' 
...
path_save = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '_pickle/' + dataset_name + '_a_raw.pickle' #
# path_save = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '_pickle/' + dataset_name + '_b_raw.pickle' #
# path_save = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '_pickle/' + dataset_name + '_c_raw.pickle' #
# path_save = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '_pickle/' + dataset_name + '_d_raw.pickle' # 
# path_save = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '_pickle/' + dataset_name + '_e_raw.pickle' #
# path_save = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '_pickle/' + dataset_name + '_f_raw.pickle' #
# path_save = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '_pickle/' + dataset_name + '_g_raw.pickle' # 
# path_save = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '_pickle/' + dataset_name + '_h_raw.pickle' #
# path_save = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '_pickle/' + dataset_name + '_i_raw.pickle' #
# path_save = 'GNNs-BreastCompression/Hold-out/' + dataset_name + '_pickle/' + dataset_name + '_j_raw.pickle' # 
