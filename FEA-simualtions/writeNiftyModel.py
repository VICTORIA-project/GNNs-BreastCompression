...
parser = argparse.ArgumentParser(description="Generate a Nifty Model from a VTK mesh.")

# Define expected arguments
parser.add_argument("-meshpath", type=str, help="Path to the VTK mesh file.")
parser.add_argument("-output","--outputpath", type=str, help="Output path for the generated XML file.")
parser.add_argument("-thickness", type=float, help="Thickness value.")
parser.add_argument("-gravity", type=float, help="Gravity value.")
parser.add_argument("-offset", type=float, help="Offset value.")
parser.add_argument("-material", type=str, help="Material type (e.g., 'NH' or 'TI').")
parser.add_argument("-anisotropyRatio", type=float, help="Anisotropy ratio.")
...
def writeNiftyModel(meshpath, outputpath,thickness, gravity, offset, material, anisotropyRatio):
    ...
    ET.SubElement(doc, "TimeStep").text = "0.00001" #0.00001
